export default {
	...
	pt: {
		...
		skulk: {
			...
			content: 'Queres aprender Vue.js? Junta-te a uma Skulk Vue Vixen de graça!',
		},
		program: {
			title: 'O Programa',
		...
		request: {
			title: 'Pedir',
			content: 'Ogranizadores de enventos, registem-se para terem um workshop no vosso evento.',
		},
	},
	pt_br: {
		heading: {
		...
		skulk: {
			...
			content: 'Quer aprender Vue.js? Junte-se a uma Skulk Vue Vixen de graça!',
		},
		program: {
			title: 'O Programa',
			content: 'Estudantes e mentores, aprendam mais sobre o nosso programa.',
		...
		request: {
			...
			content: 'Organizadores de eventos, registrem-se para ter um workshop em seu evento.',
		},
	},
	fr: {
		heading: {
